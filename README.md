...
<div align="center">
  <img src="request.jpeg" alt="Request to agent" width="80%" style="border: 2px solid #4CAF50; border-radius: 8px; padding: 10px; margin: 15px 0;">
  <p><strong>User Interface</strong> - Submit your queries to the Cosmic Navigator AI Agent</p>
</div>

##  Agent Response
<div align="center">
  <img src="responce.jpeg" alt="Response generated by agent" width="80%" style="border: 2px solid #2196F3; border-radius: 8px; padding: 10px; margin: 15px 0;">
